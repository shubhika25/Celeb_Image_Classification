...
import cv2 
import numpy as np
#from util import get_cropped_images_if_2_eyes
...
# Loads image from base64 data , crops the face and eyes and extracts feature using the wavelet and raw pixeel data 
# feeds it into classifier and return the data def get_cropped_images_if_2_eyes(file_path, image_base64_data):
def classify_image(image_base64_data , file_path = None):
    ...
    for img in imgs : 
        ...
        result.append({
            'class' : __class_number_to_name(__model.predict(final_input)[0]),
